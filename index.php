...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801823456789</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">The Sun Rise resort is a luxury facility that is intended primarily for vacationers and is usually located near special attractions, such as beaches and seashores, scenic or historic areas, ski parks, or spas.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Enjoy your day with full of joy! </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>The Sun Rise resort gives you a luxury facility that is intended primarily for you and your family.</p>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/tms1.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/tms2.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/tms3.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/tmss4.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					<div class="resp-tabs-container">
					<div class="tab1">
						<div class="col-md-6 team-img-w33-agile">
						</div>
						<div class="col-md-6 team-Info-agileits">
							<h4>Momtaj Hossain</h4>
							<span>Manager</span>
							<p>We are responsible for ensuring our guests enjoy their stay. With this in mind, we may be tasked with several duties aimed at enhancing the guest experience and seeing to positive customer relations. These may include: Meeting and greeting guests with a warm welcome.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>They were extremely accommodating and allowed us to check in early at like 10am.
									 We got to hotel super early and I didn’t wanna wait.
									  So this was a big plus. The sevice was exceptional as well.
									   Would definitely send a friend there. </p>
								<h5>Tashin Sharon</h5>
								<p>Bogura</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/cc2.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p> I had a wonderful experience at the Sun Rise. Every staff member I encountered,
									 from the valet to the check- in to the cleaning staff were delightful and
									  eager to help! Thank you! Will recommend to my colleagues! </p>
								<h5>Faria Hassan</h5>
								<p>Dhaka</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/cc3.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/cc4.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p> Every staff member I encountered, from the valet to the check- in
									 to the cleaning staff were delightful and eager to help!
									  Thank you! Will recommend to my colleagues! </p>
								<h5>Sattajit Ghosh</h5>
								<p>Dhaka</p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801823456789</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Main Road,Gazipur,Dhaka</p>
